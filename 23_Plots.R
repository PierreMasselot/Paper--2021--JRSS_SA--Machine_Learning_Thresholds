...
#                               2021
#
#                       Plotting application results
#
#                    Code Author: Pierre Masselot
#
################################################################################

# This script should be executed after 22_Bootstrap.R
# Plots results of the bootstrap and comparison between methods, 
#   generating Figures 6 and 7 as well as Table 2.
...
dev.print(pdf, file = "Results/Figure7.pdf")
